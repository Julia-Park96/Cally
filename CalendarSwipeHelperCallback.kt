...
class CalendarSwipeHelperCallback(val calendarRecyclerAdapter: CalendarRecyclerAdapter) : ItemTouchHelper.Callback(){
    ...
    override fun onMove(
        ...
        calendarRecyclerAdapter.swapData(fromPos, toPos)
        return true
    }
